...
@section('content')
    ...
    <div class="page-content settings container-fluid">
                                    ...
                                    <div class="col-md-10 no-padding-left-right">
                                        ...
                                        @elseif($setting->type == "image" || $setting->type == "file")
                                            @if(isset( $setting->value ) && !empty( $setting->value ) && Storage::disk(config('voyager.storage.disk'))->exists($setting->value))
                                                <div class="img_settings_container  @if($setting->key === 'site.footer_logo') bg-primary @endif">
            ...
            <button type="submit" form="settings" class="btn btn-primary pull-right">{{ __('voyager::settings.save') }}</button>
...
@section('javascript')
    <script>
        $('document').ready(function () {
            ...
            // Instagram
            let username = $('#instagram_username')
            $('#instagramSave').hide()
            username.keyup(function() {
                if($(this).data("value") == username.val()) $('#instagramSave').hide()
                else $('#instagramSave').show()
            });
